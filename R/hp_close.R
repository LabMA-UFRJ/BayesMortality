...
#'
#' @description This function receives an object of the class 'HP' adjusted by the hp() function
...
#'
#' @param fit Object of the class 'HP' adjusted by the hp() function
#' @param method Character string specifying the closing method to be fitted, with them being: 'hp', 'plateau', 'linear' or 'gompertz'.
#' @param x0 Integer with the starting age the closing method will be fitted from. Default: Last age fitted by the 'HP' object.
#' @param max_age Integer with the maximum age the closing method will be fitted till. Default: 120 years old.
...
#'
#' @details The four closing methods implemented by the function are:
...
hp_close = function(fit, method = c("hp", "plateau", "linear", "gompertz"), x0 = max(fit$data$x),
  ...
  ## Checklist
  if(class(fit) != "HP") { stop("fit argument must be a 'HP' Object returned by hp() function.") }
